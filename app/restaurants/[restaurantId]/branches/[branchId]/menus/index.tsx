...
export default function BranchMenuListScreen () {
          ...
          renderItem={({ item }) => (
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                paddingVertical: 4,
                backgroundColor: selectedMenu === item.id ? Colors[colorScheme ?? "light"].buttonBackground : Colors[colorScheme ?? "light"].inactiveButtonBackground,
                minHeight: 30,
                minWidth: 63,
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              ...
              <Text
                style={{
                  ...
                  color: selectedMenu === item.id ? Colors[colorScheme ?? "light"].buttonForeground : Colors[colorScheme ?? "light"].inactiveBUttonForeground
                }}
              >
                {item.name}
              </Text>
          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => router.push(`/restaurants/${restaurantId}/branches/${branchId}/menus/${menuSection.menuId}/sections/${menuSection.id}`)}
              >
                <Text
                  style={{
                    fontFamily: "Metropolis-Medium",
